...
@section('content')
	<div class="row">
		<div class="col-xs-12 col-md-12 col-sm-12">
			...
			<div class="row border-1 border-solid border-grey-light p-sm ml-0 mr-0 hidden-xs">
			...
			@if (!empty($data['carts']))
				<div class="row border-right-1 border-left-1 border-bottom-1 border-grey-light p-sm ml-0 mr-0 hidden-xs">
